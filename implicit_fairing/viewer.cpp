...
void Viewer::drawContents() {
	...
	if (selection_) {
		...
		shaderSelection_.drawIndexed(GL_TRIANGLES, 0, mesh_->get_number_of_face());
	}
...
void Viewer::initShaders() {
	...
	/*shaderSelection_.init(
		...
		"uniform mat4 P;\n"
		"void main() {\n"
		"    vec4 vpoint_mv = MV * vec4(selection, 1.0);\n"
		"    gl_Position = P * vpoint_mv;\n"
		"}",
...
void Viewer::refresh_mesh() {
	...
	//shaderSelection_.bind();
	//shaderSelection_.uploadAttrib("selection", *(mesh_->get_selection()));
